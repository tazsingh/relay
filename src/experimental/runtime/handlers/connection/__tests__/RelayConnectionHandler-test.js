...
describe('RelayConnectionHandler', () => {
  ...
  beforeEach(() => {
    ...
    ({ConnectionQuery} = generateWithTransforms(`
      query ConnectionQuery($id: ID!, $before: ID $count: Int, $after: ID) {
        node(id: $id) {
          ... on User {
            friends(before: $before, after: $after, first: $count)
            @__clientField(handle: "connection") {
              edges {
                cursor
                node {
                  id
  ...
  describe('insertEdgeAfter()', () => {
    ...
    beforeEach(() => {
      ...
      const payload = {
        ...
        handleKey: getRelayHandleName('friends', 'connection'),
      };
      ...
      connection = RelayConnectionHandler.getConnection(proxy.get('4'), 'friends');
    ...
    it('appends the edge if no cursor is supplied', () => {
      ...
      expect(sinkData[connectionID]).toEqual({
        ...
        [TYPENAME_KEY]: 'FriendsConnection',
        edges: {[REFS_KEY]: [
          'client:4:__friends_connection:edges:0',
          'client:4:__friends_connection:edges:1',
          'newedge',
        ]},
      });
    });
  ...
  describe('update()', () => {
    ...
    it('creates a client connection with initial server data', () => {
      ...
      expect(sinkData).toEqual({
        4: { __id: '4',
          [ID_KEY]: '4',
          [TYPENAME_KEY]: 'User',
          [payload.handleKey]: {[REF_KEY]: 'client:4:__friends_connection'},
        },
        'client:4:__friends_connection': {
          [ID_KEY]: 'client:4:__friends_connection',
          [TYPENAME_KEY]: 'FriendsConnection',
          edges: {[REFS_KEY]: ['client:4:__friends_connection:edges:0']},
          [PAGE_INFO]: {[REF_KEY]: 'client:4:__friends_connection:pageInfo'},
          __connection_next_edge_index: 1,
        },
        'client:4:__friends_connection:edges:0': {
          [ID_KEY]: 'client:4:__friends_connection:edges:0',
          [TYPENAME_KEY]: 'FriendsEdge',
          cursor: 'cursor:1',
          node: {[REF_KEY]: '1'},
        },
        'client:4:__friends_connection:pageInfo': {
          [ID_KEY]: 'client:4:__friends_connection:pageInfo',
    ...
    describe('subsequent fetches', () => {
      ...
      it('appends new edges', () => {
        ...
        const args = {after: 'cursor:1', first: 10};
        const payload = {
          args,
          dataID: '4',
          fieldKey: formatStorageKey('friends', args),
        ...
        expect(sinkData).toEqual({
          ...
          'client:4:__friends_connection:edges:1': {
            [ID_KEY]: 'client:4:__friends_connection:edges:1',
            [TYPENAME_KEY]: 'FriendsEdge',
            cursor: 'cursor:2',
            node: {[REF_KEY]: '2'},
          },
      ...
      it('prepends new edges', () => {
        ...
        const args = {before: 'cursor:1', first: 10};
        const payload = {
          args,
          dataID: '4',
          fieldKey: formatStorageKey('friends', args),
        ...
        expect(sinkData).toEqual({
          'client:4:__friends_connection': {
            ...
            edges: {[REFS_KEY]: [
              ...
              'client:4:__friends_connection:edges:2',
            ]},
          ...
          'client:4:__friends_connection:edges:2': {
            [ID_KEY]: 'client:4:__friends_connection:edges:2',
            [TYPENAME_KEY]: 'FriendsEdge',
            cursor: 'cursor:3',
            node: {[REF_KEY]: '3'},
          },
      ...
      it('skips backward pagination payloads with unknown cursors', () => {
        ...
        const args = {before: '<unknown-cursor>', first: 10};
        const payload = {
          args,
          dataID: '4',
          fieldKey: formatStorageKey('friends', args),
      ...
      it('skips forward pagination payloads with unknown cursors', () => {
        ...
        const args = {after: '<unknown-cursor>', first: 10};
        const payload = {
          args,
          dataID: '4',
          fieldKey: formatStorageKey('friends', args),
