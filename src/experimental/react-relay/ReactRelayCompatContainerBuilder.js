...
function buildCompatContainer<TBase: ReactClass<*>>(
  ...
  injectedVariableProvider?: VariablesProvider,
): TBase {
  ...
  function getDefaultVariables() {
    if (injectedDefaultVariables == null) {
      injectedDefaultVariables = injectedVariableProvider ?
        injectedVariableProvider() :
        {};
    }
  ...
  function getFragment(
    ...
    const fragment = RelayGraphQLTag.getLegacyFragment(taggedNode);
  ...
  function hasVariable(variableName: string): boolean {
    return Object.keys(fragmentSpec).some(fragmentName => {
      const fragment = RelayGraphQLTag.getLegacyFragment(fragmentSpec[fragmentName]);
...
module.exports = {buildCompatContainer};
